...
public class Project implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.requestSpecificationUrl == null) {
            if (other.requestSpecificationUrl != null)
                return false;
        }
        else if (!this.requestSpecificationUrl.equals(other.requestSpecificationUrl))
            return false;
        if (this.name == null) {
            if (other.name != null)
                return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.requestSpecificationUrl == null) ? 0 : this.requestSpecificationUrl.hashCode());
