...
public class UserCertificateHistory extends TableImpl<UserCertificateHistoryRecord> {
     ...
     */
    public static final UserCertificateHistory USER_CERTIFICATE_HISTORY = new UserCertificateHistory();
    ...
    /**
     * The column
     * <code>SION.user_certificate_history.user_certificate_history_id</code>.
     */
    public final TableField<UserCertificateHistoryRecord, Long> USER_CERTIFICATE_HISTORY_ID = createField(DSL.name("user_certificate_history_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>SION.user_certificate_history.created_at</code>.
     */
    public final TableField<UserCertificateHistoryRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>SION.user_certificate_history.updated_at</code>.
     */
    public final TableField<UserCertificateHistoryRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>SION.user_certificate_history.updated_by</code>.
     */
    public final TableField<UserCertificateHistoryRecord, String> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.VARCHAR(30).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>SION.user_certificate_history.certificate_name</code>.
     */
    public final TableField<UserCertificateHistoryRecord, String> CERTIFICATE_NAME = createField(DSL.name("certificate_name"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column
     * <code>SION.user_certificate_history.employee_identification_number</code>.
     */
    public final TableField<UserCertificateHistoryRecord, String> EMPLOYEE_IDENTIFICATION_NUMBER = createField(DSL.name("employee_identification_number"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    private UserCertificateHistory(Name alias, Table<UserCertificateHistoryRecord> aliased) {
        this(alias, aliased, null);
    }

    private UserCertificateHistory(Name alias, Table<UserCertificateHistoryRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table());
    }

    /**
     * Create an aliased <code>SION.user_certificate_history</code> table
     * reference
     */
    ...
    public <O extends Record> UserCertificateHistory(Table<O> child, ForeignKey<O, UserCertificateHistoryRecord> key) {
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Long, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? super String, ? extends U> from) {
