...
public class Project extends TableImpl<ProjectRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function14<? super String, ? super String, ? super String, ? super Long, ? super LocalDate, ? super LocalDate, ? super LocalDate, ? super ProjectStatus, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function14<? super String, ? super String, ? super String, ? super Long, ? super LocalDate, ? super LocalDate, ? super LocalDate, ? super ProjectStatus, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? extends U> from) {
