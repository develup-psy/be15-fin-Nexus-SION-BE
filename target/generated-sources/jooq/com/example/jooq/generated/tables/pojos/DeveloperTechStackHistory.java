...
public class DeveloperTechStackHistory implements Serializable {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.developerTechStackHistoryId == null) ? 0 : this.developerTechStackHistoryId.hashCode());
        ...
        result = prime * result + ((this.cumulativeScore == null) ? 0 : this.cumulativeScore.hashCode());
