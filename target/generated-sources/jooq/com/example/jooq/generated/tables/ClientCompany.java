...
public class ClientCompany extends TableImpl<ClientCompanyRecord> {
    ...
    public final TableField<ClientCompanyRecord, String> CLIENT_CODE = createField(
    ...
    public final TableField<ClientCompanyRecord, String> COMPANY_NAME =
                    createField(DSL.name("company_name"), SQLDataType.VARCHAR(255).defaultValue(
                                    DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /** The column <code>SION.client_company.created_at</code>. */
    public final TableField<ClientCompanyRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<ClientCompanyRecord, LocalDateTime> UPDATED_AT = createField(
                    DSL.name("updated_at"),
                    SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(
                                    DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)),
                    this, "");
    ...
    public final TableField<ClientCompanyRecord, String> CONTACT_PERSON =
                    createField(DSL.name("contact_person"), SQLDataType.VARCHAR(10).defaultValue(
                                    DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /** The column <code>SION.client_company.email</code>. */
    public final TableField<ClientCompanyRecord, String> EMAIL =
                    createField(DSL.name("email"), SQLDataType.VARCHAR(30).defaultValue(
                                    DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /** The column <code>SION.client_company.contact_number</code>. */
    public final TableField<ClientCompanyRecord, String> CONTACT_NUMBER =
                    createField(DSL.name("contact_number"), SQLDataType.VARCHAR(21).defaultValue(
                                    DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /** The column <code>SION.client_company.domain_name</code>. */
    public final TableField<ClientCompanyRecord, String> DOMAIN_NAME = createField(
                    DSL.name("domain_name"), SQLDataType.VARCHAR(30).nullable(false), this, "");
    ...
    public <O extends Record> ClientCompany(Table<O> child,
                    ForeignKey<O, ClientCompanyRecord> key) {
    ...
    public <U> SelectField<U> mapping(
                    Function8<? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {
