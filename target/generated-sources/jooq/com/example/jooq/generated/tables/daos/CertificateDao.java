...
public class CertificateDao extends
                DAOImpl<CertificateRecord, com.example.jooq.generated.tables.pojos.Certificate, String> {
    ...
    /** Fetch a unique record that has <code>certificate_name = value</code> */
    public Optional<com.example.jooq.generated.tables.pojos.Certificate> fetchOptionalByCertificateName(
                    String value) {
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.Certificate> fetchRangeOfIssuingOrganizationId(
                    LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(Certificate.CERTIFICATE.ISSUING_ORGANIZATION_ID, lowerInclusive,
                        upperInclusive);
    }
