...
public class UserCertificateHistory implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.userCertificateHistoryId == null) {
            if (other.userCertificateHistoryId != null)
                return false;
        }
        else if (!this.userCertificateHistoryId.equals(other.userCertificateHistoryId))
            return false;
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.userCertificateHistoryId == null) ? 0 : this.userCertificateHistoryId.hashCode());
