...
public class JobAndTechStack extends TableImpl<JobAndTechStackRecord> {
    ...
    public final TableField<JobAndTechStackRecord, Long> JOB_AND_TECH_STACK_ID =
                    createField(DSL.name("job_and_tech_stack_id"),
                                    SQLDataType.BIGINT.nullable(false), this, "");

    /** The column <code>SION.job_and_tech_stack.tech_stack_id</code>. */
    public final TableField<JobAndTechStackRecord, String> TECH_STACK_ID = createField(
                    DSL.name("tech_stack_id"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /** The column <code>SION.job_and_tech_stack.project_and_job_id</code>. */
    public final TableField<JobAndTechStackRecord, Long> PROJECT_AND_JOB_ID = createField(
    ...
    public final TableField<JobAndTechStackRecord, Integer> PRIORITY =
                    createField(DSL.name("priority"), SQLDataType.INTEGER.defaultValue(
                                    DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");

    /** The column <code>SION.job_and_tech_stack.created_at</code>. */
    public final TableField<JobAndTechStackRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<JobAndTechStackRecord, LocalDateTime> UPDATED_AT = createField(
                    DSL.name("updated_at"),
                    SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(
                                    DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)),
                    this, "");
    ...
    public <O extends Record> JobAndTechStack(Table<O> child,
                    ForeignKey<O, JobAndTechStackRecord> key) {
    ...
    public List<ForeignKey<JobAndTechStackRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FK_TECH_STACK_TO_JOB_AND_TECH_STACK_1,
                        Keys.FK_PROJECT_AND_JOB_TO_JOB_AND_TECH_STACK_1);
    }
    ...
    public ProjectAndJob projectAndJob() {
        if (_projectAndJob == null)
            _projectAndJob = new ProjectAndJob(this,
                            Keys.FK_PROJECT_AND_JOB_TO_JOB_AND_TECH_STACK_1);
    ...
    public <U> SelectField<U> mapping(
                    Function6<? super Long, ? super String, ? super Long, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
