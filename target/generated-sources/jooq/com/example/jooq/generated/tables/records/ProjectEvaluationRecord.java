...
public class ProjectEvaluationRecord extends UpdatableRecordImpl<ProjectEvaluationRecord> implements Record10<Long, String, Long, Long, Integer, Integer, Integer, Integer, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public ProjectEvaluationRecord values(Long value1, String value2, Long value3, Long value4, Integer value5, Integer value6, Integer value7, Integer value8, LocalDateTime value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectEvaluationRecord(Long projectEvaluationId, String projectCode, Long developerId, Long estimatorId, Integer techFit, Integer communication, Integer problemSolving, Integer cooperationAttitude, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(ProjectEvaluation.PROJECT_EVALUATION);
