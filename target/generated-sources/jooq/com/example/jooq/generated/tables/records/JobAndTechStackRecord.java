...
public class JobAndTechStackRecord extends UpdatableRecordImpl<JobAndTechStackRecord> implements Record6<Long, String, Long, Integer, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public JobAndTechStackRecord values(Long value1, String value2, Long value3, Integer value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JobAndTechStackRecord(Long jobAndTechStackId, String techStackName, Long projectAndJobId, Integer priority, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(JobAndTechStack.JOB_AND_TECH_STACK);
