...
public class TrainingProgramDao extends
                DAOImpl<TrainingProgramRecord, com.example.jooq.generated.tables.pojos.TrainingProgram, String> {
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfTrainingName(
        ...
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.TRAINING_NAME, lowerInclusive,
                        upperInclusive);
    }
    ...
    /** Fetch a unique record that has <code>training_name = value</code> */
    public Optional<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchOptionalByTrainingName(
                    String value) {
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfDescription(
                    String lowerInclusive, String upperInclusive) {
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.DESCRIPTION, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfTrainingType(
                    TrainingProgramTrainingType lowerInclusive,
                    TrainingProgramTrainingType upperInclusive) {
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.TRAINING_TYPE, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfOrganizer(
                    String lowerInclusive, String upperInclusive) {
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.ORGANIZER, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfStartedAt(
        ...
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.STARTED_AT, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfEndedAt(
                    LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.ENDED_AT, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfCreatedAt(
                    LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.CREATED_AT, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.TrainingProgram> fetchRangeOfUpdatedAt(
                    LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(TrainingProgram.TRAINING_PROGRAM.UPDATED_AT, lowerInclusive,
                        upperInclusive);
    }
