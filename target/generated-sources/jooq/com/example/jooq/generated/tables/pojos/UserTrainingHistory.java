...
public class UserTrainingHistory implements Serializable {
    ...
    public UserTrainingHistory(Long userTrainigHistoryId, LocalDateTime createdAt,
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.userTrainigHistoryId == null) ? 0
                        : this.userTrainigHistoryId.hashCode());
