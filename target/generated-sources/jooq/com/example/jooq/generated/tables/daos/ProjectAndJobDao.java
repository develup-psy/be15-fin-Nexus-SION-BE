...
public class ProjectAndJobDao extends
                DAOImpl<ProjectAndJobRecord, com.example.jooq.generated.tables.pojos.ProjectAndJob, Long> {

    /** Create a new ProjectAndJobDao without any configuration */
    public ProjectAndJobDao() {
        super(ProjectAndJob.PROJECT_AND_JOB,
                        com.example.jooq.generated.tables.pojos.ProjectAndJob.class);
    }

    /** Create a new ProjectAndJobDao with an attached configuration */
    public ProjectAndJobDao(Configuration configuration) {
        super(ProjectAndJob.PROJECT_AND_JOB,
                        com.example.jooq.generated.tables.pojos.ProjectAndJob.class, configuration);
    }
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfProjectAndJobId(
                    Long lowerInclusive, Long upperInclusive) {
        return fetchRange(ProjectAndJob.PROJECT_AND_JOB.PROJECT_AND_JOB_ID, lowerInclusive,
                        upperInclusive);
    }

    /** Fetch records that have <code>project_and_job_id IN (values)</code> */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchByProjectAndJobId(
                    Long... values) {
    ...
    public com.example.jooq.generated.tables.pojos.ProjectAndJob fetchOneByProjectAndJobId(
                    Long value) {
        return fetchOne(ProjectAndJob.PROJECT_AND_JOB.PROJECT_AND_JOB_ID, value);
    }

    /** Fetch a unique record that has <code>project_and_job_id = value</code> */
    public Optional<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchOptionalByProjectAndJobId(
                    Long value) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfRequiredNumber(
                    Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(ProjectAndJob.PROJECT_AND_JOB.REQUIRED_NUMBER, lowerInclusive,
                        upperInclusive);
    }

    /** Fetch records that have <code>required_number IN (values)</code> */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchByRequiredNumber(
                    Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfCreatedAt(
    ...
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchByCreatedAt(
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfUpdatedAt(
                    LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(ProjectAndJob.PROJECT_AND_JOB.UPDATED_AT, lowerInclusive, upperInclusive);
    }

    /** Fetch records that have <code>updated_at IN (values)</code> */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchByUpdatedAt(
                    LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfProjectCode(
                    String lowerInclusive, String upperInclusive) {
        return fetchRange(ProjectAndJob.PROJECT_AND_JOB.PROJECT_CODE, lowerInclusive,
                        upperInclusive);
    }

    /** Fetch records that have <code>project_code IN (values)</code> */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchByProjectCode(
                    String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfJobName(
                    String lowerInclusive, String upperInclusive) {
    ...
    public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchByJobName(
                    String... values) {
