...
public class ProjectAndJobDao
    extends DAOImpl<
        ProjectAndJobRecord, com.example.jooq.generated.tables.pojos.ProjectAndJob, Long> {

  /** Create a new ProjectAndJobDao without any configuration */
  public ProjectAndJobDao() {
    super(
        ProjectAndJob.PROJECT_AND_JOB, com.example.jooq.generated.tables.pojos.ProjectAndJob.class);
  }
  ...
  public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfProjectAndJobId(
    ...
    return fetchRange(
        ProjectAndJob.PROJECT_AND_JOB.PROJECT_AND_JOB_ID, lowerInclusive, upperInclusive);
  }
  ...
  /** Fetch a unique record that has <code>project_and_job_id = value</code> */
  public Optional<com.example.jooq.generated.tables.pojos.ProjectAndJob>
      fetchOptionalByProjectAndJobId(Long value) {
  ...
  public List<com.example.jooq.generated.tables.pojos.ProjectAndJob> fetchRangeOfRequiredNumber(
    ...
    return fetchRange(
        ProjectAndJob.PROJECT_AND_JOB.REQUIRED_NUMBER, lowerInclusive, upperInclusive);
  }
