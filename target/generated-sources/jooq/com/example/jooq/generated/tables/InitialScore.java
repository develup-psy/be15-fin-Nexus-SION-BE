...
public class InitialScore extends TableImpl<InitialScoreRecord> {
     ...
     */
    public final TableField<InitialScoreRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>SION.initial_score.years</code>.
     */
    public final TableField<InitialScoreRecord, Integer> YEARS = createField(DSL.name("years"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>SION.initial_score.score</code>.
     */
    public final TableField<InitialScoreRecord, Integer> SCORE = createField(DSL.name("score"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>SION.initial_score.created_at</code>.
     */
    public final TableField<InitialScoreRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>SION.initial_score.updated_at</code>.
     */
    public final TableField<InitialScoreRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Long, ? super Integer, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Long, ? super Integer, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
