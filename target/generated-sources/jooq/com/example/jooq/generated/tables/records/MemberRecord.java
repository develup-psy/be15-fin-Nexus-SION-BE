...
public class MemberRecord extends UpdatableRecordImpl<MemberRecord> implements Record15<String, String, String, String, String, LocalDateTime, String, Integer, Long, MemberStatus, MemberGradeCode, LocalDateTime, LocalDateTime, LocalDateTime, MemberRole> {
    ...
    @Override
    public MemberRecord values(String value1, String value2, String value3, String value4, String value5, LocalDateTime value6, String value7, Integer value8, Long value9, MemberStatus value10, MemberGradeCode value11, LocalDateTime value12, LocalDateTime value13, LocalDateTime value14, MemberRole value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MemberRecord(String employeeIdentificationNumber, String employeeName, String password, String profileImageUrl, String phoneNumber, LocalDateTime joinedAt, String email, Integer careerYears, Long salary, MemberStatus status, MemberGradeCode gradeCode, LocalDateTime createdAt, LocalDateTime updatedAt, LocalDateTime deletedAt, MemberRole role) {
        super(Member.MEMBER);
