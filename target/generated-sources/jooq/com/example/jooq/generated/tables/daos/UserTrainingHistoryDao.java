...
public class UserTrainingHistoryDao
    extends DAOImpl<
        UserTrainingHistoryRecord,
        com.example.jooq.generated.tables.pojos.UserTrainingHistory,
        Long> {
   ...
   */
  public List<com.example.jooq.generated.tables.pojos.UserTrainingHistory>
      fetchRangeOfUserTrainigHistoryId(Long lowerInclusive, Long upperInclusive) {
    return fetchRange(
  ...
  public List<com.example.jooq.generated.tables.pojos.UserTrainingHistory>
      fetchByUserTrainigHistoryId(Long... values) {
   ...
   * value</code>
   */
  public Optional<com.example.jooq.generated.tables.pojos.UserTrainingHistory>
      fetchOptionalByUserTrainigHistoryId(Long value) {
  ...
  public List<com.example.jooq.generated.tables.pojos.UserTrainingHistory> fetchRangeOfCreatedAt(
    ...
    return fetchRange(
        UserTrainingHistory.USER_TRAINING_HISTORY.CREATED_AT, lowerInclusive, upperInclusive);
  }
  ...
  public List<com.example.jooq.generated.tables.pojos.UserTrainingHistory> fetchRangeOfUpdatedAt(
      LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
    return fetchRange(
        UserTrainingHistory.USER_TRAINING_HISTORY.UPDATED_AT, lowerInclusive, upperInclusive);
  }
  ...
  public List<com.example.jooq.generated.tables.pojos.UserTrainingHistory> fetchRangeOfUpdatedBy(
    ...
    return fetchRange(
        UserTrainingHistory.USER_TRAINING_HISTORY.UPDATED_BY, lowerInclusive, upperInclusive);
  }
  ...
  public List<com.example.jooq.generated.tables.pojos.UserTrainingHistory> fetchRangeOfTrainingName(
      String lowerInclusive, String upperInclusive) {
    return fetchRange(
        UserTrainingHistory.USER_TRAINING_HISTORY.TRAINING_NAME, lowerInclusive, upperInclusive);
  }
