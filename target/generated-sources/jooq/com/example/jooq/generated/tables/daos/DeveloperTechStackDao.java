...
public class DeveloperTechStackDao extends
                DAOImpl<DeveloperTechStackRecord, com.example.jooq.generated.tables.pojos.DeveloperTechStack, Long> {
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchRangeOfDeveloperTechStackId(
                    Long lowerInclusive, Long upperInclusive) {
        return fetchRange(DeveloperTechStack.DEVELOPER_TECH_STACK.DEVELOPER_TECH_STACK_ID,
                        lowerInclusive, upperInclusive);
    }

    /** Fetch records that have <code>developer_tech_stack_id IN (values)</code> */
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchByDeveloperTechStackId(
                    Long... values) {
     ...
     * value</code>
     */
    public Optional<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchOptionalByDeveloperTechStackId(
                    Long value) {
        return fetchOptional(DeveloperTechStack.DEVELOPER_TECH_STACK.DEVELOPER_TECH_STACK_ID,
                        value);
    }
     ...
     * lowerInclusive AND upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchRangeOfTechStackTotalScores(
                    Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(DeveloperTechStack.DEVELOPER_TECH_STACK.TECH_STACK_TOTAL_SCORES,
                        lowerInclusive, upperInclusive);
    }

    /** Fetch records that have <code>tech_stack_total_scores IN (values)</code> */
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchByTechStackTotalScores(
                    Integer... values) {
     ...
     * lowerInclusive AND upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchRangeOfEmployeeIdentificationNumber(
                    String lowerInclusive, String upperInclusive) {
        return fetchRange(DeveloperTechStack.DEVELOPER_TECH_STACK.EMPLOYEE_IDENTIFICATION_NUMBER,
                        lowerInclusive, upperInclusive);
    }
     ...
     * (values)</code>
     */
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchByEmployeeIdentificationNumber(
                    String... values) {
        return fetch(DeveloperTechStack.DEVELOPER_TECH_STACK.EMPLOYEE_IDENTIFICATION_NUMBER,
                        values);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchRangeOfTechStackName(
                    String lowerInclusive, String upperInclusive) {
        return fetchRange(DeveloperTechStack.DEVELOPER_TECH_STACK.TECH_STACK_NAME, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchRangeOfCreatedAt(
        ...
        return fetchRange(DeveloperTechStack.DEVELOPER_TECH_STACK.CREATED_AT, lowerInclusive,
                        upperInclusive);
    }
    ...
    public List<com.example.jooq.generated.tables.pojos.DeveloperTechStack> fetchRangeOfUpdatedAt(
                    LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(DeveloperTechStack.DEVELOPER_TECH_STACK.UPDATED_AT, lowerInclusive,
                        upperInclusive);
    }
