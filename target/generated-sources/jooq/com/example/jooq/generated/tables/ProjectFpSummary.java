...
public class ProjectFpSummary extends TableImpl<ProjectFpSummaryRecord> {
    ...
    public final TableField<ProjectFpSummaryRecord, Integer> TOTAL_FP = createField(
                    DSL.name("total_fp"), SQLDataType.INTEGER.nullable(false), this, "");

    /** The column <code>SION.project_fp_summary.avg_effort_per_fp</code>. */
    public final TableField<ProjectFpSummaryRecord, Integer> AVG_EFFORT_PER_FP = createField(
                    DSL.name("avg_effort_per_fp"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public final TableField<ProjectFpSummaryRecord, BigDecimal> TOTAL_EFFORT =
                    createField(DSL.name("total_effort"), SQLDataType.DECIMAL(6, 2).defaultValue(
    ...
    public final TableField<ProjectFpSummaryRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<ProjectFpSummaryRecord, String> PROJECT_CODE = createField(
    ...
    public <O extends Record> ProjectFpSummary(Table<O> child,
                    ForeignKey<O, ProjectFpSummaryRecord> key) {
    ...
    public <U> SelectField<U> mapping(
                    Function8<? super String, ? super Integer, ? super Integer, ? super BigDecimal, ? super BigDecimal, ? super BigDecimal, ? super LocalDateTime, ? super String, ? extends U> from) {
