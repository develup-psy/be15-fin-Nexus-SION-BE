...
public class ProjectFpSummary extends TableImpl<ProjectFpSummaryRecord> {
     ...
     */
    public final TableField<ProjectFpSummaryRecord, Long> PROJECT_FP_SUMMARY_ID = createField(DSL.name("project_fp_summary_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    @Override
    public Row8<Long, Integer, Integer, BigDecimal, BigDecimal, BigDecimal, LocalDateTime, String> fieldsRow() {
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super Long, ? super Integer, ? super Integer, ? super BigDecimal, ? super BigDecimal, ? super BigDecimal, ? super LocalDateTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super Long, ? super Integer, ? super Integer, ? super BigDecimal, ? super BigDecimal, ? super BigDecimal, ? super LocalDateTime, ? super String, ? extends U> from) {
