...
public class SquadEmployee implements Serializable {
    ...
    public SquadEmployee(Long squadEmployeeId, LocalDate assignedDate,
    ...
    public boolean equals(Object obj) {
        ...
        if (this.squadEmployeeId == null) {
            if (other.squadEmployeeId != null)
                return false;
        } else if (!this.squadEmployeeId.equals(other.squadEmployeeId))
            return false;
        if (this.assignedDate == null) {
            if (other.assignedDate != null)
                return false;
        } else if (!this.assignedDate.equals(other.assignedDate))
            return false;
        ...
        if (this.totalSkillScore == null) {
            if (other.totalSkillScore != null)
                return false;
        } else if (!this.totalSkillScore.equals(other.totalSkillScore))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        int result = 1;
        result = prime * result
                        + ((this.squadEmployeeId == null) ? 0 : this.squadEmployeeId.hashCode());
        result = prime * result + ((this.assignedDate == null) ? 0 : this.assignedDate.hashCode());
        result = prime * result + ((this.employeeIdentificationNumber == null) ? 0
        ...
        result = prime * result
                        + ((this.totalSkillScore == null) ? 0 : this.totalSkillScore.hashCode());
        return result;
    }
