...
public class SquadEmployee implements Serializable {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.squadEmployeeId == null) ? 0 : this.squadEmployeeId.hashCode());
        ...
        result = prime * result + ((this.totalSkillScore == null) ? 0 : this.totalSkillScore.hashCode());
        return result;
    }
