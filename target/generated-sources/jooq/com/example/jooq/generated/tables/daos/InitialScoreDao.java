...
public class InitialScoreDao extends DAOImpl<InitialScoreRecord, com.example.jooq.generated.tables.pojos.InitialScore, Long> {
    ...
    public InitialScoreDao(Configuration configuration) {
        super(InitialScore.INITIAL_SCORE, com.example.jooq.generated.tables.pojos.InitialScore.class, configuration);
    }
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchRangeOfId(Long lowerInclusive, Long upperInclusive) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.example.jooq.generated.tables.pojos.InitialScore> fetchOptionalById(Long value) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchRangeOfYears(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchByYears(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchRangeOfScore(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchByScore(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchRangeOfCreatedAt(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchByCreatedAt(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchRangeOfUpdatedAt(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.example.jooq.generated.tables.pojos.InitialScore> fetchByUpdatedAt(LocalDateTime... values) {
