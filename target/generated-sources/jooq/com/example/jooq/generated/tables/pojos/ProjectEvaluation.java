...
public class ProjectEvaluation implements Serializable {
    ...
    public ProjectEvaluation(Long projectEvaluationId, String projectCode, Long developerId,
                    Long estimatorId, Integer techFit, Integer communication,
                    Integer problemSolving, Integer cooperationAttitude, LocalDateTime createdAt,
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.projectEvaluationId == null) ? 0
                        : this.projectEvaluationId.hashCode());
        ...
        result = prime * result
                        + ((this.communication == null) ? 0 : this.communication.hashCode());
        result = prime * result
                        + ((this.problemSolving == null) ? 0 : this.problemSolving.hashCode());
        result = prime * result + ((this.cooperationAttitude == null) ? 0
                        : this.cooperationAttitude.hashCode());
