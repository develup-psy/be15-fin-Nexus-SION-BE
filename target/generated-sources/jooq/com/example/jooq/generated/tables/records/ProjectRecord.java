...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements
                Record14<String, String, String, Long, LocalDate, LocalDate, LocalDate, ProjectStatus, Integer, LocalDateTime, LocalDateTime, LocalDateTime, String, String> {
    ...
    @Override
    public ProjectRecord values(String value1, String value2, String value3, Long value4,
                    LocalDate value5, LocalDate value6, LocalDate value7, ProjectStatus value8,
                    Integer value9, LocalDateTime value10, LocalDateTime value11,
                    LocalDateTime value12, String value13, String value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public ProjectRecord(String projectCode, String description, String title, Long budget,
                    LocalDate startDate, LocalDate expectedEndDate, LocalDate actualEndDate,
                    ProjectStatus status, Integer numberOfMembers, LocalDateTime createdAt,
                    LocalDateTime updatedAt, LocalDateTime deletedAt, String clientCode,
                    String name) {
        super(Project.PROJECT);
