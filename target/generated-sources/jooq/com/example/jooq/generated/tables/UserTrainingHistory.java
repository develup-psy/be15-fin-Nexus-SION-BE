...
public class UserTrainingHistory extends TableImpl<UserTrainingHistoryRecord> {
     ...
     */
    public final TableField<UserTrainingHistoryRecord, Long> USER_TRAINIG_HISTORY_ID = createField(DSL.name("user_trainig_history_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>SION.user_training_history.created_at</code>.
     */
    public final TableField<UserTrainingHistoryRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>SION.user_training_history.updated_at</code>.
     */
    public final TableField<UserTrainingHistoryRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>SION.user_training_history.updated_by</code>.
     */
    public final TableField<UserTrainingHistoryRecord, String> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>SION.user_training_history.training_name</code>.
     */
    public final TableField<UserTrainingHistoryRecord, String> TRAINING_NAME = createField(DSL.name("training_name"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column
     * <code>SION.user_training_history.employee_identification_number</code>.
     */
    public final TableField<UserTrainingHistoryRecord, String> EMPLOYEE_IDENTIFICATION_NUMBER = createField(DSL.name("employee_identification_number"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    private UserTrainingHistory(Name alias, Table<UserTrainingHistoryRecord> aliased) {
        this(alias, aliased, null);
    }

    private UserTrainingHistory(Name alias, Table<UserTrainingHistoryRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> UserTrainingHistory(Table<O> child, ForeignKey<O, UserTrainingHistoryRecord> key) {
    ...
    /**
     * Get the implicit join path to the <code>SION.training_program</code>
     * table.
     */
    public TrainingProgram trainingProgram() {
        if (_trainingProgram == null)
            _trainingProgram = new TrainingProgram(this, Keys.FK_TRAINING_PROGRAM_TO_USER_TRAINING_HISTORY_1);
