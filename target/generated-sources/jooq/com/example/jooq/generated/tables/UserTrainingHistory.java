...
public class UserTrainingHistory extends TableImpl<UserTrainingHistoryRecord> {
    ...
    public final TableField<UserTrainingHistoryRecord, Long> USER_TRAINIG_HISTORY_ID =
                    createField(DSL.name("user_trainig_history_id"),
                                    SQLDataType.BIGINT.nullable(false), this, "");

    /** The column <code>SION.user_training_history.created_at</code>. */
    public final TableField<UserTrainingHistoryRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<UserTrainingHistoryRecord, LocalDateTime> UPDATED_AT = createField(
                    DSL.name("updated_at"),
                    SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(
                                    DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)),
                    this, "");
    ...
    public final TableField<UserTrainingHistoryRecord, String> UPDATED_BY = createField(
                    DSL.name("updated_by"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /** The column <code>SION.user_training_history.training_name</code>. */
    public final TableField<UserTrainingHistoryRecord, String> TRAINING_NAME = createField(
    ...
    public <O extends Record> UserTrainingHistory(Table<O> child,
                    ForeignKey<O, UserTrainingHistoryRecord> key) {
    ...
    public List<ForeignKey<UserTrainingHistoryRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FK_DEVELOPER_TO_USER_TRAINING_HISTORY_1,
    ...
    public TrainingProgram trainingProgram() {
        if (_trainingProgram == null)
            _trainingProgram = new TrainingProgram(this,
                            Keys.FK_TRAINING_PROGRAM_TO_USER_TRAINING_HISTORY_1);
