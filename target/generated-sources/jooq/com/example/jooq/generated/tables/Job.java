...
public class Job extends TableImpl<JobRecord> {
    ...
    public final TableField<JobRecord, String> NAME = createField(DSL.name("name"),
                    SQLDataType.VARCHAR(30).nullable(false), this, "");

    /** The column <code>SION.job.created_at</code>. */
    public final TableField<JobRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<JobRecord, LocalDateTime> UPDATED_AT = createField(
                    DSL.name("updated_at"),
                    SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(
                                    DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)),
                    this, "");
