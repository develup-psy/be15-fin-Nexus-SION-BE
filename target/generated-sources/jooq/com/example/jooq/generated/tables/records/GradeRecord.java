...
public class GradeRecord extends UpdatableRecordImpl<GradeRecord> implements Record6<GradeGradeCode, Integer, Integer, Integer, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public GradeRecord values(GradeGradeCode value1, Integer value2, Integer value3, Integer value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GradeRecord(GradeGradeCode gradeCode, Integer minScore, Integer maxScore, Integer monthlyUnitPrice, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Grade.GRADE);
