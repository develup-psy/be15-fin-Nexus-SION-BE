...
public class Squad extends TableImpl<SquadRecord> {
    ...
    public final TableField<SquadRecord, String> SQUAD_CODE = createField(DSL.name("squad_code"),
                    SQLDataType.VARCHAR(30).nullable(false), this, "");

    /** The column <code>SION.squad.project_code</code>. */
    public final TableField<SquadRecord, String> PROJECT_CODE = createField(
                    DSL.name("project_code"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /** The column <code>SION.squad.title</code>. */
    public final TableField<SquadRecord, String> TITLE = createField(DSL.name("title"),
                    SQLDataType.VARCHAR(30).nullable(false), this, "");

    /** The column <code>SION.squad.is_active</code>. */
    public final TableField<SquadRecord, Byte> IS_ACTIVE = createField(DSL.name("is_active"),
                    SQLDataType.TINYINT.nullable(false), this, "");

    /** The column <code>SION.squad.created_at</code>. */
    public final TableField<SquadRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<SquadRecord, LocalDateTime> UPDATED_AT = createField(
                    DSL.name("updated_at"),
                    SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(
                                    DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)),
                    this, "");
    ...
    public final TableField<SquadRecord, BigDecimal> ESTIMATED_DURATION =
                    createField(DSL.name("estimated_duration"),
                                    SQLDataType.DECIMAL(5, 2)
    ...
    public final TableField<SquadRecord, BigDecimal> ESTIMATED_COST =
                    createField(DSL.name("estimated_cost"), SQLDataType.DECIMAL(12, 2).defaultValue(
                                    DSL.field(DSL.raw("NULL"), SQLDataType.DECIMAL)), this, "");

    /** The column <code>SION.squad.origin_type</code>. */
    public final TableField<SquadRecord, SquadOriginType> ORIGIN_TYPE = createField(
                    DSL.name("origin_type"),
                    SQLDataType.VARCHAR(6).nullable(false).asEnumDataType(
                                    com.example.jooq.generated.enums.SquadOriginType.class),
                    this, "");

    /** The column <code>SION.squad.recommendation_reason</code>. */
    public final TableField<SquadRecord, String> RECOMMENDATION_REASON =
                    createField(DSL.name("recommendation_reason"),
    ...
    public <U> SelectField<U> mapping(
                    Function10<? super String, ? super String, ? super String, ? super Byte, ? super LocalDateTime, ? super LocalDateTime, ? super BigDecimal, ? super BigDecimal, ? super SquadOriginType, ? super String, ? extends U> from) {
