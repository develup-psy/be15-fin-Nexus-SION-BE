...
public class DeveloperTechStack extends TableImpl<DeveloperTechStackRecord> {
    ...
    public final TableField<DeveloperTechStackRecord, Integer> TECH_STACK_TOTAL_SCORES =
                    createField(DSL.name("tech_stack_total_scores"),
    ...
    public final TableField<DeveloperTechStackRecord, String> TECH_STACK_NAME = createField(
    ...
    public final TableField<DeveloperTechStackRecord, LocalDateTime> CREATED_AT = createField(
                    DSL.name("created_at"),
    ...
    public final TableField<DeveloperTechStackRecord, LocalDateTime> UPDATED_AT = createField(
                    DSL.name("updated_at"),
                    SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(
                                    DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)),
                    this, "");
    ...
    public <O extends Record> DeveloperTechStack(Table<O> child,
                    ForeignKey<O, DeveloperTechStackRecord> key) {
    ...
    public List<ForeignKey<DeveloperTechStackRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FK_DEVELOPER_TO_DEVELOPER_TECH_STACK_1,
                        Keys.FK_TECH_STACK_TO_DEVELOPER_TECH_STACK_1);
    }
    ...
    public <U> SelectField<U> mapping(
                    Function6<? super Long, ? super Integer, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
