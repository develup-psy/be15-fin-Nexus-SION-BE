...
public class DeveloperTechStack extends TableImpl<DeveloperTechStackRecord> {
     ...
     */
    public final TableField<DeveloperTechStackRecord, Long> DEVELOPER_TECH_STACK_ID = createField(DSL.name("developer_tech_stack_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column
     * <code>SION.developer_tech_stack.tech_stack_total_scores</code>.
     */
    public final TableField<DeveloperTechStackRecord, Integer> TECH_STACK_TOTAL_SCORES = createField(DSL.name("tech_stack_total_scores"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column
     * <code>SION.developer_tech_stack.employee_identification_number</code>.
     */
    public final TableField<DeveloperTechStackRecord, String> EMPLOYEE_IDENTIFICATION_NUMBER = createField(DSL.name("employee_identification_number"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>SION.developer_tech_stack.tech_stack_name</code>.
     */
    public final TableField<DeveloperTechStackRecord, String> TECH_STACK_NAME = createField(DSL.name("tech_stack_name"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>SION.developer_tech_stack.created_at</code>.
     */
    public final TableField<DeveloperTechStackRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>SION.developer_tech_stack.updated_at</code>.
     */
    public final TableField<DeveloperTechStackRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp()"), SQLDataType.LOCALDATETIME)), this, "");

    private DeveloperTechStack(Name alias, Table<DeveloperTechStackRecord> aliased) {
        this(alias, aliased, null);
    }

    private DeveloperTechStack(Name alias, Table<DeveloperTechStackRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> DeveloperTechStack(Table<O> child, ForeignKey<O, DeveloperTechStackRecord> key) {
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super Integer, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Long, ? super Integer, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
