...
public class Sion extends SchemaImpl {
    ...
    public final DeveloperTechStackHistory DEVELOPER_TECH_STACK_HISTORY =
    ...
    public final ProjectFunctionEstimate PROJECT_FUNCTION_ESTIMATE =
    ...
    public final UserCertificateHistory USER_CERTIFICATE_HISTORY =
                    UserCertificateHistory.USER_CERTIFICATE_HISTORY;

    /** The table <code>SION.user_training_history</code>. */
    public final UserTrainingHistory USER_TRAINING_HISTORY =
    ...
    public final List<Table<?>> getTables() {
        return Arrays.asList(Certificate.CERTIFICATE, ClientCompany.CLIENT_COMPANY,
                        DeveloperTechStack.DEVELOPER_TECH_STACK,
                        DeveloperTechStackHistory.DEVELOPER_TECH_STACK_HISTORY, Domain.DOMAIN,
                        Grade.GRADE, InitialScore.INITIAL_SCORE, Job.JOB,
                        JobAndTechStack.JOB_AND_TECH_STACK, Member.MEMBER, Project.PROJECT,
                        ProjectAndJob.PROJECT_AND_JOB, ProjectEvaluation.PROJECT_EVALUATION,
                        ProjectFpSummary.PROJECT_FP_SUMMARY,
                        ProjectFunctionEstimate.PROJECT_FUNCTION_ESTIMATE, Squad.SQUAD,
                        SquadEmployee.SQUAD_EMPLOYEE, TechStack.TECH_STACK,
