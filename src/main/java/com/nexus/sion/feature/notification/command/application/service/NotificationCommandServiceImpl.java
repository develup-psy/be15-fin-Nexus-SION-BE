...
public class NotificationCommandServiceImpl implements NotificationCommandService {
    ...
    @Override
    @Transactional
    public void createAndSendNotification(String senderId, String receiverId, String message, NotificationType type, String linkedContentId) {
        ...
        String senderName = memberRepository.findEmployeeNameByEmployeeIdentificationNumber(senderId)
    ...
    public SseEmitter subscribe(String employeeIdentificationNumber, String lastEventId) {
        ...
        String emitterId = employeeIdentificationNumber + "_" + UUID.randomUUID() + "_" + System.currentTimeMillis();
        ...
        sendToClient(emitterId, emitter, "알림 서버 연결 성공. [memberId = " + employeeIdentificationNumber + "]");


        if (!lastEventId.isEmpty()) {
            Map<String, Object> events = sseEmitterRepository.findAllEventCacheStartWithId(employeeIdentificationNumber);
    ...
    public void send(String employeeIdentificationNumber, Object data) {
        Map<String, SseEmitter> emitters = sseEmitterRepository.findAllEmittersStartWithId(employeeIdentificationNumber);
