...
public class MemberScoreQueryRepository {
  ...
  public MemberScoreHistoryRecord getPreviousTechScoreChangedRecord(
      String employeeId, int currentTechScore) {
    return dsl.selectFrom(MEMBER_SCORE_HISTORY)
        .where(MEMBER_SCORE_HISTORY.EMPLOYEE_IDENTIFICATION_NUMBER.eq(employeeId))
  ...
  public MemberScoreHistoryRecord getPreviousCertificateScoreChangedRecord(
      String employeeId, int currentCertScore) {
    return dsl.selectFrom(MEMBER_SCORE_HISTORY)
        .where(MEMBER_SCORE_HISTORY.EMPLOYEE_IDENTIFICATION_NUMBER.eq(employeeId))
