...
public class SquadCombinationGeneratorImpl {
  public List<Map<String, List<DeveloperSummary>>> generate(
      Map<String, List<DeveloperSummary>> candidates, Map<String, Integer> requiredCountByRole) {
  ...
  private Map<String, List<DeveloperSummary>> deepCopy(
      Map<String, List<DeveloperSummary>> original) {
