...
class DeveloperCertificateHistoryServiceImplTest {
    ...
    void registerUserCertificate_success() {
        ...
        MockMultipartFile pdfFile = new MockMultipartFile("file", "test.pdf", "application/pdf", "dummy".getBytes());

        UserCertificateHistoryRequest request = UserCertificateHistoryRequest.builder()
        ...
        given(documentS3Service.uploadFile(any(), any()))
                .willReturn(new S3UploadResponse("https://s3.aws.com/certificates/test.pdf", "uuid.pdf", "test.pdf"));
