...
class InitialScoreCommandServiceImplTest {
    ...
    @Mock
    private InitialScoreRepository initialScoreRepository;

    @InjectMocks
    private InitialScoreCommandServiceImpl initialScoreCommandService;

    @Test
    void setInitialScores_success() {
        // given
        List<InitialScoreDto> scores = Arrays.asList(
        ...
        InitialScoreSetRequset request = InitialScoreSetRequset.builder()
        ...
        verify(initialScoreRepository, times(3)).save(any());
    }
    ...
    void setInitialScores_lastMaxYearsShouldBeNull() {
        ...
        List<InitialScoreDto> scores = Arrays.asList(
                InitialScoreDto.builder().minYears(1).maxYears(5).score(50).build(),
                InitialScoreDto.builder().minYears(6).maxYears(10).score(60).build(),
                InitialScoreDto.builder().minYears(11).maxYears(15).score(70).build() // 마지막 maxYears가 null이 아님
        );
    ...
    void setInitialScores_intervalYearsShouldBeContinuous() {
        ...
        List<InitialScoreDto> scores = Arrays.asList(
                InitialScoreDto.builder().minYears(1).maxYears(5).score(50).build(),
                InitialScoreDto.builder().minYears(7).maxYears(10).score(60).build(), // 5 + 1 != 7 -> 연속성 오류
                InitialScoreDto.builder().minYears(11).maxYears(null).score(70).build()
        );
