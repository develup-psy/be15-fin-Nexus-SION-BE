...
class UserCommandServiceTest {
    ...
    void registerUser_실패_비밀번호형식불일치() {
        ...
        UserCreateRequest invalidRequest =
                new UserCreateRequest(
                        "EMP123", "홍길동", "Password1", "01011111111", "test@example.com"
                );
        // when
    ...
    void registerUser_실패_휴대폰번호형식불일치() {
        ...
        UserCreateRequest invalidRequest =
                new UserCreateRequest(
                        "EMP123", "홍길동", "Password123!", "010-1234-5678", "test@example.com"
                ); // 하이픈 포함된 잘못된 번호
    ...
    void registerUser_실패_이메일형식불일치() {
        ...
        UserCreateRequest invalidRequest =
                new UserCreateRequest(
                        "EMP123", "홍길동", "Password123!", "01012345678", "invalid-email" // @ 없음
                );
