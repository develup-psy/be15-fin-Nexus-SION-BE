...
class AdminCertificateCommandServiceImplTest {
  ...
  @InjectMocks private AdminCertificateCommandServiceImpl certificateCommandService;
  ...
  void deleteCertificate_success() {
    ...
    String certName = "정보처리기사";
    Certificate certificate =
        Certificate.builder().certificateName(certName).issuingOrganization("기관").score(10).build();
