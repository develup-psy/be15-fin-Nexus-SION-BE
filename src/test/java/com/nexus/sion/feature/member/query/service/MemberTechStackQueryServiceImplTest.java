...
class MemberTechStackQueryServiceImplTest {
    ...
    @Mock
    private MemberTechStackQueryRepository memberTechStackQueryRepository;

    @InjectMocks
    private MemberTechStackQueryServiceImpl memberTechStackQueryService;
    ...
    void getTechStacks_success() {
        ...
        List<MemberTechStackResponse> expected = List.of(
                new MemberTechStackResponse("Java", 90),
                new MemberTechStackResponse("Spring", 85)
        );
