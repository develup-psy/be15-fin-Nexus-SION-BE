...
class UserCertificateHistoryQueryServiceImplTest {
    ...
    void setUp() {
        ...
        userCertificateHistoryQueryService = new UserCertificateHistoryQueryServiceImpl(userCertificateHistoryQueryRepository);
    }
    ...
    void getMyCertificates_shouldReturnCertificateList() {
        ...
        List<UserCertificateHistoryResponse> mockResponse = List.of(
    ...
    void findOwnedCertificateNamesByEmployee_shouldReturnApprovedCertificateNames() {
        ...
        when(userCertificateHistoryQueryRepository.findOwnedCertificateNamesByStatus(
                employeeId, UserCertificateHistoryCertificateStatus.APPROVED)).thenReturn(owned);

        // when
        List<String> result = userCertificateHistoryQueryService.findOwnedCertificateNamesByEmployee(employeeId);

        // then
        assertThat(result).isEqualTo(owned);
        verify(userCertificateHistoryQueryRepository).findOwnedCertificateNamesByStatus(
