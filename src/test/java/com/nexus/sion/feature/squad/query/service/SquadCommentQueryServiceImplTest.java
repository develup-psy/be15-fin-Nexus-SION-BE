...
class SquadCommentQueryServiceImplTest {
    ...
    @Mock
    private SquadCommentQueryRepository squadCommentQueryRepository;

    @InjectMocks
    private SquadCommentQueryServiceImpl squadCommentQueryService;
    ...
    void findCommentsBySquadCode_success() {
        ...
        SquadCommentResponse comment1 = new SquadCommentResponse(
                1L,
                "홍길동",
                "DEV001",
                "리더 배정이 필요합니다.",
