...
class SquadQueryServiceImplTest {
    ...
    void getSquads_success() {
        ...
        SquadListResponse dummy = new SquadListResponse(
    ...
    void findCandidatesByRoles_success() {
        ...
        DeveloperSummary dev = DeveloperSummary.builder()
                .id("DEV001")
                .name("홍길동")
                .grade("MID")
                .avgTechScore(90.0)
        ...
        given(squadQueryMapper.findJobsByProjectId(projectId))
                .willReturn(List.of(job1));
