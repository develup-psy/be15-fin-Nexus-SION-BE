...
@DisplayName("SquadManualServiceImplTest 단위 테스트")
class SquadManualServiceImplTest {
    @InjectMocks private SquadManualServiceImpl squadManualService;
    ...
    void registerManualSquad_success() {
        ...
        willDoNothing()
                .given(squadValidationService)
                .validateDevelopersExist(List.of(developer));
        willDoNothing()
                .given(squadValidationService)
