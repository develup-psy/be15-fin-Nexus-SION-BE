...
class SquadCommandServiceImplTest {
    ...
    @InjectMocks
    private SquadCommandServiceImpl squadCommandService;

    @Mock
    private SquadCommandRepository squadCommandRepository;

    @Mock
    private SquadEmployeeCommandRepository squadEmployeeCommandRepository;
