...
class SquadQueryIntegrationTest {
  ...
  void setUp() {
    ...
    Long projectAndJobId = dsl.insertInto(PROJECT_AND_JOB)
  ...
  void getSquadDetail_success() throws Exception {
    mockMvc
            .perform(get("/api/v1/squads/{squadCode}", testSquadCode)
  ...
  void getSquadsByProjectCode_success() throws Exception {
    mockMvc
            .perform(get("/api/v1/squads/project/{projectCode}", testProjectCode)
                    .param("page", "0")
                    .param("size", "10"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.success").value(true))
  ...
  void getCandidatesByRoles_success() throws Exception {
    mockMvc
            .perform(get("/api/v1/squads/candidates")
