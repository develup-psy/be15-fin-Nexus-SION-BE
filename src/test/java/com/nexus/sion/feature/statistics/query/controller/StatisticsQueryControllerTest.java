...
class StatisticsQueryControllerTest {
  ...
  void getStackMemberCount_success() throws Exception {
    ...
    List<TechStackCountDto> result =
        List.of(new TechStackCountDto("Java", 5), new TechStackCountDto("Vue.js", 3));
  ...
  void getStackAverageCareerPaged_success() throws Exception {
    ...
    when(service.getStackAverageCareersPaged(
            List.of("Java", "Spring Boot"), 0, 10, "techStackName", "asc"))
        .thenReturn(page);
