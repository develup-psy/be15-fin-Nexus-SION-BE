...
public class ReplacmentRecommendationServiceImplTest {
    ...
    @Mock
    private ReplacementRecommendationRepository recommendationRepository;
    @Mock private CalculateSquad calculateSquad;

    @InjectMocks
    private ReplacementRecommendationServiceImpl service;
    ...
    void recommendCandidates_success_returnsTop5() {
        ...
        List<DeveloperSummary> candidates = List.of(
